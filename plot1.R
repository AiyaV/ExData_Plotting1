...
> if(!file.exists('my_plots_EDA')) dir.create('my_plots_EDA')
> png(filename = './my_plots_EDA/plot1.png', width = 480, height = 480, units='px')
> with(dataEDA, hist(Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)"))
> dev.off
